...
class SfenHandler(webapp.RequestHandler):
    ...
    def piece_img_init(self):
        ...
        f = open("img/naky.png", "rb")
        naky_img = f.read()
        f.close()

        f = open("img/nake.png", "rb")
        nake_img = f.read()
        f.close()

        f = open("img/nagi.png", "rb")
        nagi_img = f.read()
        f.close()
        ...
        self.piece_img['+l'] = (naky_img, images.rotate(naky_img, 180))
        self.piece_img['+n'] = (nake_img, images.rotate(nake_img, 180))
        self.piece_img['+s'] = (nagi_img, images.rotate(nagi_img, 180))
